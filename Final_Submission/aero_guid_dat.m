...
% 0 : Random switching among modes 1~5
% 1 : Straight
% 2 : Evasive
% 3 : Random
% 4 : Reactive
...
%==================================================================
% Target Evasive Maneuver
%==================================================================

t_turn_start = 1.0;       % Turn start time [s]
t_turn_end   = 2.0;       % Turn end time [s]

n_turn       = 3.0;       % Target normal acceleration command [g]
n_tgt_max    = 5.0;       % Maximum target maneuver acceleration [g]
...
V_tgt = 328;              % target speed [m/s]
maxTargetG = 40;          % 공격적인 시험 조건 [g]

omegaPhysMax = ...
    maxTargetG*9.81/V_tgt;  % maximum physical turn rate [rad/s]

omegaDotMax = ...
    600*pi/180;             % maximum turn-rate change [rad/s^2]


% 회전율 명령 변화율 제한 [rad/s^2]
omegaDotMax = 600*pi/180;

target_max_turn_rate = 60*pi/180;
